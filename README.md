...
## Getting started
[![Python Version](https://img.shields.io/badge/python-3.12-blue.svg)](https://www.python.org/downloads/release/python-3919/)
...
```command line
git clone https://github.com/Shaadalam9/ehmi-vehicle
cd multiped
```
...
**Step 8:** Ensure that dataset are present. Place required datasets into the **data/** directory:
